...
function UpdateWeapon(chosenWeapon, weaponFolder)
            ...
            function pagetypes:Section(options)
                ...
                function sectiontypes:Slider(options)
                    ...
                    local function slide(input)
                        ...
                        utility.tween(fill, { newincrement / 100 }, { Size = UDim2.new(newsizeX, 0, 1, 0) })
...
local Window = Library:New({ Name = '<font color=\"#8557F2\">catgirl.fun</font> | rush point', Accent = Color3.fromRGB(133, 87, 242) })
local Pages = {
...
local Sections = {
	Combat = {
		...
		Settings = Pages.Aiming:Section({ Name = "settings", Side = "Right" })
	},
	Visuals = {
...
local Combat = {
	BulletRedirection = {
		Enabled = Sections.Combat.BulletRedirection:Toggle({
            Name = "enabled",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
                cheat_table.Combat.BulletRedirection.Enabled = state
            end
        }),--[[
		VisibleCheck = Sections.Combat.BulletRedirection:Toggle({
            Name = "visible check",
            Default = false,
            Pointer = "visiblecheck",
            callback = function(state)
                cheat_table.Combat.BulletRedirection.VisibleCheck = state
            end
        }),
		HitChance = Sections.Combat.BulletRedirection:Slider({
            ...
            callback = function(state)
                cheat_table.Combat.BulletRedirection.HitChance = state
            end
        }),]]
		Hitboxes = Sections.Combat.BulletRedirection:Dropdown({
            ...
            Pointer = "hitbox",
            callback = function(state)
                cheat_table.Combat.BulletRedirection.Hitboxes = state
            end
        })
	},
	Modifications = {
		RemoveSpread = Sections.Combat.Modifications:Toggle({
            Name = "remove spread",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
                cheat_table.Combat.Modifications.RemoveSpread = state
            end
        }),
		RemoveRecoil = Sections.Combat.Modifications:Toggle({
            ...
            Pointer = "bulletredirectionenabled",
            callback = function(state)
                cheat_table.Combat.Modifications.RemoveRecoil = state
            end
        }),
	},
	Settings = {
		UseFOV = Sections.Combat.Settings:Toggle({
            Name = "use fov",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
		...
		DrawFOV = Sections.Combat.Settings:Toggle({
            Name = "draw fov",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
                main_circle.Visible = state
				if cheat_table.Combat.Settings.Outline then
					inside_circle.Visible = state
					outside_circle.Visible = state
				end
				cheat_table.Combat.Settings.DrawFOV = state
            end
        }),--[[
		FilledFOV = Sections.Combat.Settings:Toggle({
            Name = "filled",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
				if cheat_table.Combat.Settings.DrawFOV then
                	filled_circle.Visible = state
				else
					filled_circle.Visible = false
				end
				cheat_table.Combat.Settings.FilledFOV = state
            end
        }),]]
		OutlineFOV = Sections.Combat.Settings:Toggle({
            Name = "outline",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
				...
				cheat_table.Combat.Settings.Outline = state
            end
        }),
		Radius = Sections.Combat.Settings:Slider({
            Name = "radius",
            Minimum = 1,
            Maximum = 360,
            Default = 35,
            ...
            Pointer = "radius",
            callback = function(state)
                filled_circle.Radius = state - 1.5
				main_circle.Radius = state
				inside_circle.Radius = state - 1.5
				outside_circle.Radius = state + 1.5
				cheat_table.Combat.Settings.Radius = state
            end
        }),
		Snapline = Sections.Combat.Settings:Toggle({
            Name = "snapline",
            Default = false,
            Pointer = "bulletredirectionenabled",
            callback = function(state)
		...
		SnaplineOrigin = Sections.Combat.Settings:Dropdown({
            Name = "origin",
            Options = {"Mouse", "Top", "Bottom", "Middle"},
            Default = "Mouse",
            Pointer = "snaplineorigin",
            callback = function(state)
                print(state)
            end
        })
...
Combat.Settings.DrawFOV:Colorpicker({
	Name = "fov color",
	Info = "fov color",
	Alpha = 0.5,
	...
	Pointer = "fovcolor",
	callback = function(state)
		main_circle.Color = state
	end
})
--[[
Combat.Settings.FilledFOV:Colorpicker({
	Name = "filled fov color",
	Info = "filled fov color",
	Alpha = 0.5,
	Default = Color3.fromRGB(133, 87, 242),
	Pointer = "filledfovcolor",
	callback = function(state)
		filled_circle.Color = state
	end
})
]]
Combat.Settings.Snapline:Colorpicker({
	Name = "snapline color",
	Info = "snapline color",
	Alpha = 0.5,
	Default = Color3.fromRGB(255, 255, 255),
...
local Visuals = {
	Players = {
        ...
        HealthText = Sections.Visuals.Players:Toggle({
            ...
            Pointer = "534253424532",
            callback = function(state)
                espLib.options.healthText = state
            end
        }),
        ...
        Arrows = Sections.Visuals.Players:Toggle({
            ...
            Pointer = "534253424532",
            callback = function(state)
                espLib.options.outOfViewArrows = state
            end
        }),
        ArrowsFilled = Sections.Visuals.Players:Toggle({
            Name = "arrows filled",
            Default = false,
            Pointer = "534253424532",
            callback = function(state)
                espLib.options.outOfViewArrowsFilled = state
            end
        }),
        ArrowsRadius = Sections.Combat.Settings:Slider({
            Name = "arrows radius",
            Minimum = 1,
            Maximum = 360,
            Default = 35,
...
local Knife = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Knife:GetChildren()) do
	table.insert(Knife, v.Name)
end

local Chancellor = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Chancellor:GetChildren()) do
	table.insert(Chancellor, v.Name)
end

local Sentinel = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Sentinel:GetChildren()) do
	table.insert(Sentinel, v.Name)
end

local Crimson = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Crimson:GetChildren()) do
	table.insert(Crimson, v.Name)
end

local Eclipse = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Eclipse:GetChildren()) do
	table.insert(Eclipse, v.Name)
end

local Vapor = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Vapor:GetChildren()) do
	table.insert(Vapor, v.Name)
end

local Fury = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Fury:GetChildren()) do
	table.insert(Fury, v.Name)
end

local Infuser = {}
for i, v in pairs(game:GetService("ReplicatedStorage").Assets.Weapons.Infuser:GetChildren()) do
	table.insert(Infuser, v.Name)
end


local Misc = {
	SkinChanger = {
		Knife = Sections.Misc.SkinChanger:Dropdown({
            Name = "knife",
            Options = Knife,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Knife")
            end
        }),
		Chancellor = Sections.Misc.SkinChanger:Dropdown({
            Name = "chancellor",
            Options = Chancellor,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Chancellor")
            end
        }),
		Sentinel = Sections.Misc.SkinChanger:Dropdown({
            Name = "sentinel",
            Options = Sentinel,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Sentinel")
            end
        }),
		Crimson = Sections.Misc.SkinChanger:Dropdown({
            Name = "crimson",
            Options = Crimson,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Crimson")
            end
        }),
		Eclipse = Sections.Misc.SkinChanger:Dropdown({
            Name = "eclipse",
            Options = Eclipse,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Eclipse")
            end
        }),
		Vapor = Sections.Misc.SkinChanger:Dropdown({
            Name = "vapor",
            Options = Vapor,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Vapor")
            end
        }),
		Fury = Sections.Misc.SkinChanger:Dropdown({
            Name = "fury",
            Options = Fury,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Fury")
            end
        }),
		Infuser = Sections.Misc.SkinChanger:Dropdown({
            Name = "infuser",
            Options = Infuser,
			Default = 'Default',
            Pointer = "knife",
            callback = function(state)
                UpdateWeapon(state, "Infuser")
            end
        }),
	}
}
...
local Network = LoadedModules.Network;
...
local function GetNearest()
    ...
    for Index, Value in next, Players:GetPlayers() do
            ...
            if (not Char:FindFirstChild(cheat_table.Combat.BulletRedirection.Hitboxes)) then continue end;
            ...
            if (magnitude > cheat_table.Combat.Settings.Radius) then continue end;

            table.insert(Targets, {Value, Distance, Char:FindFirstChild(cheat_table.Combat.BulletRedirection.Hitboxes)});
        end;
    end;
...
for Index, Value in next, getgc(true) do
    if (type(Value) == 'function') and (islclosure(Value)) and (#getupvalues(Value) == 5) and (type(getupvalue(Value, 4)) == 'table') and (rawget(getupvalue(Value, 4), 'LastAimPunchSpringX')) then
        ...
        hookfunction(Value, function(...)
            if cheat_table.Combat.Modifications.RemoveRecoil then
                return;
            end;
            return Old(...)
        end)
...
game:GetService('RunService').PostSimulation:Connect(function()
    ...
    if cheat_table.Combat.Modifications.RemoveSpread then
